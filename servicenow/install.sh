...
echo "The servicenow/path.zsh in your dotfiles adds ~/.local/bin to PATH for Claude Code."
echo "Reload your shell to pick up the new PATH:"
echo "   source ~/.zshrc"
echo ""
echo "Verify Claude Code is in PATH:"
echo "   which claude"
echo ""
echo "Next steps:"
echo "1. Run 'claude' to start Claude Code"
echo ""
echo "2. Inside Claude Code, install the ServiceNow plugin:"
...
echo "   now-sdk init"
echo ""
echo "4. Set up credentials for deployment:"
echo "   now-sdk deploy (prompts for instance URL, username, password)"
echo ""
